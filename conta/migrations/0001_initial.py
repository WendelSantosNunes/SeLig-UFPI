    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.CharField(choices=[('Administração', 'Administração'), ('Biblioteca Setorial', 'Biblioteca Setorial'), ('Ciências Biológicas', 'Ciências Biológicas'), ('Enfermagem', 'Enfermagem'), ('História', 'História'), ('Letras', 'Letras'), ('Matemática', 'Matemática'), ('Medicina', 'Medicina'), ('Nutrição', 'Nutrição'), ('Núcleo de Assistência Estudantil (NAE)', 'Núcleo de Assistência Estudantil (NAE)'), ('Pedagogia', 'Pedagogia'), ('Restaurante Universitário (RU)', 'Restaurante Universitário (RU)'), ('Sistemas de Informação', 'Sistemas de Informação'), ('Outro', 'Outro')], max_length=38, null=True, verbose_name='*Curso')),
